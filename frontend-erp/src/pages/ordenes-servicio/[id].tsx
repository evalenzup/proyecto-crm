                ...
                <Descriptions.Item label="Dirección" span={2}>
                  <Space size={8} align="start">
                    ...
                    {(data.latitud && data.longitud)
                      ? <a href={`https://www.google.com/maps?q=${data.latitud},${data.longitud}`} target="_blank" rel="noopener noreferrer" title="Ver en Google Maps (coordenadas exactas)"><EnvironmentOutlined style={{ color: '#cf1322', fontSize: 16 }} /></a>
                      : data.direccion_servicio
                      ? <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(data.direccion_servicio)}`} target="_blank" rel="noopener noreferrer" title="Buscar dirección en Google Maps"><EnvironmentOutlined style={{ color: '#cf1322', fontSize: 16 }} /></a>
                      : null}
                  </Space>
                </Descriptions.Item>
              )}
