...
export const getFacturasPendientes = (clienteId: string, empresaId?: string, matchRfc: boolean = false) =>
  getData<FacturaPendiente[]>(api.get(`/pagos/clientes/${clienteId}/facturas-pendientes`, { params: { empresa_id: empresaId, match_rfc: matchRfc } }));
