...
export const ACCIONES_AUDITORIA = [
    ...
    { label: 'Actualizar Usuario', value: 'ACTUALIZAR_USUARIO' },
    { label: 'Eliminar Usuario', value: 'ELIMINAR_USUARIO' },
    { label: 'Asignar Empresas a Usuario', value: 'ASIGNAR_EMPRESAS_USUARIO' },
    { label: 'Asignar Permisos a Usuario', value: 'ASIGNAR_PERMISOS_USUARIO' },
    { label: 'Crear Contacto', value: 'CREAR_CONTACTO' },
    { label: 'Actualizar Contacto', value: 'ACTUALIZAR_CONTACTO' },
    { label: 'Eliminar Contacto', value: 'ELIMINAR_CONTACTO' },
    { label: 'Crear Producto/Servicio', value: 'CREAR_PRODUCTO' },
    { label: 'Actualizar Producto/Servicio', value: 'ACTUALIZAR_PRODUCTO' },
    { label: 'Eliminar Producto/Servicio', value: 'ELIMINAR_PRODUCTO' },
    { label: 'Crear Tipo de Equipo', value: 'CREAR_TIPO_EQUIPO' },
    { label: 'Actualizar Tipo de Equipo', value: 'ACTUALIZAR_TIPO_EQUIPO' },
    { label: 'Eliminar Tipo de Equipo', value: 'ELIMINAR_TIPO_EQUIPO' },
    { label: 'Crear Estado de Equipo', value: 'CREAR_ESTADO_EQUIPO' },
    { label: 'Actualizar Estado de Equipo', value: 'ACTUALIZAR_ESTADO_EQUIPO' },
    { label: 'Eliminar Estado de Equipo', value: 'ELIMINAR_ESTADO_EQUIPO' },
    { label: 'Crear Equipo', value: 'CREAR_EQUIPO' },
    { label: 'Actualizar Equipo', value: 'ACTUALIZAR_EQUIPO' },
    { label: 'Eliminar Equipo', value: 'ELIMINAR_EQUIPO' },
    { label: 'Alta Masiva de Equipos', value: 'ALTA_MASIVA_EQUIPOS' },
