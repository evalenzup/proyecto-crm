...
"""
Catálogo generado a partir de la hoja 'c_ObjetoImp'
"""
...
CATALOGO: List[Dict[str, str]] = [
    ...
    {"clave": "06", "descripcion": "Sí objeto del IVA, No traslado IVA."},
    {"clave": "07", "descripcion": "No traslado del IVA, Sí desglose IEPS."},
    {"clave": "08", "descripcion": "No traslado del IVA, No desglose IEPS."},
]
