...
CATALOGO: List[Dict[str, str]] = [
    ...
    {'clave': 'XBA', 'descripcion': 'Unidad de Mercados de Bonos Unidad Europea Composite (EURCO)'},
    {'clave': 'XBB', 'descripcion': 'Unidad Monetaria de Bonos de Mercados Unidad Europea (UEM-6)'},
    {'clave': 'XBC', 'descripcion': 'Mercados de Bonos Unidad Europea unidad de cuenta a 9 (UCE-9)'},
    {'clave': 'XBD', 'descripcion': 'Mercados de Bonos Unidad Europea unidad de cuenta a 17 (UCE-17)'},
    ...
    {'clave': 'XTS', 'descripcion': 'Códigos reservados específicamente para propósitos de prueba'},
    {'clave': 'XUA', 'descripcion': 'Unidad ADB de Cuenta'},
    {'clave': 'XXX', 'descripcion': 'Los códigos asignados para las transacciones en que intervenga ninguna moneda'},
