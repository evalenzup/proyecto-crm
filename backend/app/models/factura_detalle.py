...
class FacturaDetalle(Base):
    ...
    importe              = Column(Numeric(18, 6), nullable=False, default=0)  # cantidad * valor_unitario - descuento
    ...
    ieps_tasa_cuota      = Column(Numeric(18, 6), nullable=True)   # puede ser cuota específica
