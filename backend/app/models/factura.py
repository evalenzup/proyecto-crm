...
from sqlalchemy import (
    Column, String, Text, TIMESTAMP, Numeric, ForeignKey, UniqueConstraint,
    Index, DateTime, Integer
)
...
class Factura(Base):
    ...
    cfdi_relacionados_tipo = Column(String(2),  nullable=True)          # c_TipoRelacion (p.ej. 01, 02, ...)
