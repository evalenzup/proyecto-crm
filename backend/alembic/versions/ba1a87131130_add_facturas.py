...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "impuestos_trasladados", sa.Numeric(precision=18, scale=6), nullable=False
        ),
        sa.Column(
            "impuestos_retenidos", sa.Numeric(precision=18, scale=6), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_facturas_cliente_id"), "facturas", ["cliente_id"], unique=False
    )
    op.create_index(
        op.f("ix_facturas_empresa_id"), "facturas", ["empresa_id"], unique=False
    )
    op.create_index(
        "ix_facturas_fechas_pago",
        "facturas",
        ["fecha_pago", "fecha_cobro"],
        unique=False,
    )
    op.create_index(
        "ix_facturas_serie_folio", "facturas", ["serie", "folio"], unique=False
    )
    op.create_index(
        "ix_facturas_status_pago", "facturas", ["status_pago"], unique=False
    )
    op.create_table(
        "facturas_detalle",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_facturas_detalle_claves",
        "facturas_detalle",
        ["clave_producto", "clave_unidad"],
        unique=False,
    )
    op.create_index(
        op.f("ix_facturas_detalle_factura_id"),
        "facturas_detalle",
        ["factura_id"],
        unique=False,
    )
    op.create_index(
        "ix_facturas_detalle_no_ident",
        "facturas_detalle",
        ["no_identificacion"],
        unique=False,
    )
    op.create_index(
        op.f("ix_facturas_detalle_producto_servicio_id"),
        "facturas_detalle",
        ["producto_servicio_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_facturas_detalle_producto_servicio_id"), table_name="facturas_detalle"
    )
